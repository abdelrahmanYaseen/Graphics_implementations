//khalid amairi 2110971//
//Esmafer Direybattogullari 2015998//
...
int main(void)
{
    ...
    GLint mvp_location, eyepos_location, vtex_location, m_location,isRock_location,lightPosition_location;
    ...
    eyepos_location = glGetUniformLocation(program, "EYEPOSTITION");
    isRock_location = glGetUniformLocation(program, "ISROCK");
    lightPosition_location = glGetUniformLocation(program, "LIGHTPOS");
	...
	mat4x4_rotate_Y(m,m,(float)glfwGetTime());
	   ...
	   glUniform3fv(eyepos_location, 1,cam);
	   glUniform3fv(lightPosition_location, 1,lightSource);
	   glUniform1f(isRock_location, (GLfloat)-0.1);
	...
	mat4x4_scale_aniso(m,m,0.4,0.4,0.4);
	   ...
	   glUniform3fv(eyepos_location, 1,cam);
	   glUniform3fv(lightPosition_location, 1,lightSource);
	   glUniform1f(isRock_location, (GLfloat)5.0);
    	glUniform1i(glGetUniformLocation(program, "texturemap"), 0);
	...
	mat4x4_translate_in_place(m,3,0,0);
	   ...
	   glUniform1f(isRock_location, (GLfloat)5.0);
	    ...
	    glUniform1f(isRock_location, (GLfloat)7.0);
